...
type genericElectricityMeter struct {
	name        string
	role        domain.ElectricitySourceRole
	lineIndices []uint8
	attributes  string
	phases      uint8
}

func (g *genericElectricityMeter) Name() string {
	return g.name
}

func (g *genericElectricityMeter) Role() domain.ElectricitySourceRole {
	return g.role
}
...
func (cm *compoundElectricityMeter) StartReading(ctx context.Context) domain.ElectricityMeter {
...
func NewCompoundElectricityMeter(name string, role domain.ElectricitySourceRole, meters []domain.ElectricityMeter) domain.ElectricityMeter {
